...
RUN  unzip /opt/oracle/instantclient-basic-linux.x64-19.5.0.0.0dbru.zip -d /opt/oracle \
    ...
    #&& ln -s /opt/oracle/instantclient_19_5/libclntsh.so.12.1 /opt/oracle/instantclient_19_5/libclntsh.so \
    #&& ln -s /opt/oracle/instantclient_19_5/libclntshcore.so.12.1 /opt/oracle/instantclient_19_5/libclntshcore.so \
    #&& ln -s /opt/oracle/instantclient_19_5/libocci.so.12.1 /opt/oracle/instantclient_19_5/libocci.so \
